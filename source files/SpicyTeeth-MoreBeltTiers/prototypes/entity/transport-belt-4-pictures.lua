tier_4_belt_animation_set =
{
    animation_set =
    {
        filename = "__spicy-teeth-more-belt-tiers__/graphics/entity/transport-belt-4/transport-belt-4.png",
        priority = "extra-high",
        width = 64,
        height = 64,
        frame_count = 32,
        ...
        hr_version =
        {
            filename = "__spicy-teeth-more-belt-tiers__/graphics/entity/transport-belt-4/hr-transport-belt-4.png",
            priority = "extra-high",
            width = 128,
            height = 128,
            scale = 0.5,
